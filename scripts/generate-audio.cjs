// generate-audio.js
// Script pour générer les fichiers audio du Coran avec l'API TTS Tencent Cloud
...
// Initialiser le client TTS
const client = new TtsClient({
    credential: {
        secretId: process.env.TENCENTCLOUD_SECRET_ID,
        secretKey: process.env.TENCENTCLOUD_SECRET_KEY,
    },
    region: process.env.TENCENTCLOUD_REGION || 'ap-singapore',
    profile: {
        httpProfile: {
...
async function main() {
    ...
    // Tester avec seulement l'arabe pour commencer
    ...
    for (const langue of langues) {
        ...
        // Limiter à 10 versets pour le test
